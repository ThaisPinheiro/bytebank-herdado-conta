...
public class TesteOrdenacao {
	...
	public static void main(String[] args) {
        ...
        clienteCC3.setNome("Matheus");
        cc3.setTitular(clienteCC3);
        cc3.deposita(111.0);
 
        Conta cc4 = new ContaPoupanca(22, 22);
        Cliente clienteCC4 = new Cliente();
        clienteCC4.setNome("Jose");
        ...
        //NumeroContaComparator numeroComparator = new NumeroContaComparator();
        lista.sort(null);
        
        //Collections.sort(lista,new NumeroContaComparator());
        //Collections.reverse(lista);
        //Collections.shuffle(lista); //embaralhar
        //Collections.rotate(lista, 1); //rotacionar
        
        System.out.println("\n-----------------------------------------------------------------");
        System.out.println("Ordenação atual.\n");
        for(Conta conta:lista) {
        	System.out.println(conta + ", Nome:  " + conta.getTitular().getNome());
        }
	}
